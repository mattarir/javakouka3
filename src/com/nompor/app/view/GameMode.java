...
public class GameMode extends GameView {
	...
	public void draw(Graphics g) {
		...
		if ( isGameResult ) {
			...
			g.drawString("HIT数 : "+breakNum+" × 100 = "+(breakNum * 100), 150, 270);
		...
		g.setColor(Color.WHITE);
		g.setFont(statusFont);
		GraphicsUtil.drawCenteringString(g, "HIT数:"+breakNum, 400, 25);
